...
DEFAULT_INPUT_PATH = f"./roscoe_data/generated/"
DEFAULT_OUTPUT_PATH = f"./scores/"

DATASETS = ["i2b2_2010_test_prediction_task_prefix", "i2b2_2010_test_from_gpt3"]
# DATASETS = ["i2b2_2010_test_from_chatglm","i2b2_2010_test_from_flanT5"]
    ...
    def update_evaluator(self, in_file: str):
        ...
        with open(in_file) as _f:
            for line in _f:
                ...
                h_chain = ReasoningSteps(line=jline["CoT"])
                context = ReasoningSteps(
                    line=jline["sentence"] + " The answer is " + jline["relation"]["relation_type"]
                )
                if "gsm8k" in in_file:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="./roscoe-512-roberta-base",
